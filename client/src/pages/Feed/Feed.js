...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    fetch('https://graphql-api-dm.herokuapp.com/graphql', {
      method: 'POST',
      headers: {
  ...
  finishEditHandler = (postData) => {
    ...
    fetch('https://graphql-api-dm.herokuapp.com/post-image', {
      method: 'PUT',
      headers: {
        Authorization: 'Bearer ' + this.props.token,
      },
      ...
      .then((fileResData) => {
        ...
        return fetch('https://graphql-api-dm.herokuapp.com/graphql', {
          method: 'POST',
          body: JSON.stringify(graphqlQuery),
          headers: {
            Authorization: 'Bearer ' + this.props.token,
